...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://7c5adbk1af.execute-api.us-east-1.amazonaws.com/stage1';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'x-amz-meta-customLabels', 'body'], ['body']);
